...
@Configuration
class FrankfurterExchangeRateCircuitBreakConfig {

    public static final String FIND_EXCHANGE_RATE_CIRCUIT_BREAKER_NAME = "findFrankfurterExchangeRateCircuitBreaker";
    ...
    @Bean
    public String registerFrankfurterFindExchangeRateCircuitBreaker(CircuitBreakerRegistry registry) {
